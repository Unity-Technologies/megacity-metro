...
namespace Unity.MegacityMetro.UI
{
    ...
    public class ModalWindow : MonoBehaviour
    {
        ...
        private void OnBackAction()
        {
            ...
            if (MainMenu.Instance.CurrentState == MenuState.ModalWindow)
            {
                Hide();
            }
        }
        ...
        private void AnimateOut()
        {
            ...
            m_ModalWindowPanel.experimental.animation.Start(new StyleValues {top = 0}, new StyleValues {top = -100f}, 500)
